---
name: activate
description: Activate the Flowy deliberation overlay for this session (auto-invokes antonbabenko/deliberation skills at the right gate).
---

# Activate the deliberation overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay deliberation <overlay-plugin-root>`
