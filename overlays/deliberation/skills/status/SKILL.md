---
name: status
description: Report whether the Flowy deliberation overlay is active and whether the enforcement hook is live this session.
---

# Status of the deliberation overlay
