---
name: activate
description: Activate the Flowy compound-engineering overlay for this session (auto-invokes EveryInc/compound-engineering-plugin skills at the right gate).
---

# Activate the compound-engineering overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay compound-engineering <overlay-plugin-root>`
