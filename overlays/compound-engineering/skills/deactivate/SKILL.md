---
name: deactivate
description: Deactivate the Flowy compound-engineering overlay for this session (clears its routing obligation).
---

# Deactivate the compound-engineering overlay

Invoke `flowy-core:_activator` with the argument:  `deactivate compound-engineering`

This forwards to the engine's DEACTIVATE path, which removes the `compound-engineering` entry from
