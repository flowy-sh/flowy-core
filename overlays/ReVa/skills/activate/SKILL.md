---
name: activate
description: Activate the Flowy ReVa overlay for this session (auto-invokes cyberkaida/reverse-engineering-assistant skills at the right gate).
---

# Activate the ReVa overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay ReVa <overlay-plugin-root>`
