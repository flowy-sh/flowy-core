---
name: activate
description: Activate the Flowy superml overlay for this session (auto-invokes Leeroo-AI/superml skills at the right gate).
---

# Activate the superml overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay superml <overlay-plugin-root>`
