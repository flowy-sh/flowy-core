---
name: deactivate
description: Deactivate the Flowy crypto-trading-desk overlay for this session (clears its routing obligation).
---

# Deactivate the crypto-trading-desk overlay

Invoke `flowy-core:_activator` with the argument:  `deactivate crypto-trading-desk`

This forwards to the engine's DEACTIVATE path, which removes the `crypto-trading-desk` entry from
