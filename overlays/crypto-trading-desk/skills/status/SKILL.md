---
name: status
description: Report whether the Flowy crypto-trading-desk overlay is active and whether the enforcement hook is live this session.
---

# Status of the crypto-trading-desk overlay
