---
name: activate
description: Activate the Flowy sanity overlay for this session (auto-invokes sanity-io/agent-toolkit skills at the right gate).
---

# Activate the sanity overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay sanity <overlay-plugin-root>`
