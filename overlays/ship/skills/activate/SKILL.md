---
name: activate
description: Activate the Flowy ship overlay for this session (auto-invokes heliohq/ship skills at the right gate).
---

# Activate the ship overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay ship <overlay-plugin-root>`
