---
name: status
description: Report whether the Flowy vizro-e2e-flow overlay is active and whether the enforcement hook is live this session.
---

# Status of the vizro-e2e-flow overlay
