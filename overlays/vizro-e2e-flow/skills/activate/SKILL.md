---
name: activate
description: Activate the Flowy vizro-e2e-flow overlay for this session (auto-invokes mckinsey/vizro skills at the right gate).
---

# Activate the vizro-e2e-flow overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay vizro-e2e-flow <overlay-plugin-root>`
