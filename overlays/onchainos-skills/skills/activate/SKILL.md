---
name: activate
description: Activate the Flowy onchainos-skills overlay for this session (auto-invokes okx/onchainos-skills skills at the right gate).
---

# Activate the onchainos-skills overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay onchainos-skills <overlay-plugin-root>`
