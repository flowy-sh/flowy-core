---
name: status
description: Report whether the Flowy onchainos-skills overlay is active and whether the enforcement hook is live this session.
---

# Status of the onchainos-skills overlay
