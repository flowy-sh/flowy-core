---
name: activate
description: Activate the Flowy craft overlay for this session (auto-invokes drobins25/craft skills at the right gate).
---

# Activate the craft overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay craft <overlay-plugin-root>`
