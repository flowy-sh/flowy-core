---
name: status
description: Report whether the Flowy webnovel-writer overlay is active and whether the enforcement hook is live this session.
---

# Status of the webnovel-writer overlay
