---
name: activate
description: Activate the Flowy signum overlay for this session (auto-invokes heurema/signum skills at the right gate).
---

# Activate the signum overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay signum <overlay-plugin-root>`
