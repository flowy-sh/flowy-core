---
name: deactivate
description: Deactivate the Flowy student-llm-wiki overlay for this session (clears its routing obligation).
---

# Deactivate the student-llm-wiki overlay

Invoke `flowy-core:_activator` with the argument:  `deactivate student-llm-wiki`

This forwards to the engine's DEACTIVATE path, which removes the `student-llm-wiki` entry from
