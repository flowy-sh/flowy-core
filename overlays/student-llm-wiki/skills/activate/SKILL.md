---
name: activate
description: Activate the Flowy student-llm-wiki overlay for this session (auto-invokes IssacW228/student-llm-wiki skills at the right gate).
---

# Activate the student-llm-wiki overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay student-llm-wiki <overlay-plugin-root>`
