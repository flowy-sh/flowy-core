---
name: status
description: Report whether the Flowy student-llm-wiki overlay is active and whether the enforcement hook is live this session.
---

# Status of the student-llm-wiki overlay
