---
name: activate
description: Activate the Flowy mem0 overlay for this session (auto-invokes mem0ai/mem0 skills at the right gate).
---

# Activate the mem0 overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay mem0 <overlay-plugin-root>`
