---
name: deactivate
description: Deactivate the Flowy mem0 overlay for this session (clears its routing obligation).
---

# Deactivate the mem0 overlay

Invoke `flowy-core:_activator` with the argument:  `deactivate mem0`

This forwards to the engine's DEACTIVATE path, which removes the `mem0` entry from
