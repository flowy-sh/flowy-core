---
name: status
description: Report whether the Flowy rust-skills overlay is active and whether the enforcement hook is live this session.
---

# Status of the rust-skills overlay
