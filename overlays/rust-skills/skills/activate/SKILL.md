---
name: activate
description: Activate the Flowy rust-skills overlay for this session (auto-invokes zhanghandong/rust-skills skills at the right gate).
---

# Activate the rust-skills overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay rust-skills <overlay-plugin-root>`
