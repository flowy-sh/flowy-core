---
name: activate
description: Activate the Flowy ultra-powers overlay for this session (auto-invokes the right skill across 7 suites at each gate).
---

# Activate the ultra-powers overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay ultra-powers <overlay-plugin-root>`
