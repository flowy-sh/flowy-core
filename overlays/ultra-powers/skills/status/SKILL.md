---
name: status
description: Report whether the Flowy ultra-powers overlay is active and whether the enforcement hook is live this session.
---

# Status of the ultra-powers overlay
