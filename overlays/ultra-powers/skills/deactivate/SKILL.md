---
name: deactivate
description: Deactivate the Flowy ultra-powers overlay for this session (clears its routing obligation).
---

# Deactivate the ultra-powers overlay

Invoke `flowy-core:_activator` with the argument:  `deactivate ultra-powers`

This forwards to the engine's DEACTIVATE path, which removes the `ultra-powers` entry from
