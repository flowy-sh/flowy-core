---
name: activate
description: Activate the Flowy firecrawl overlay for this session (auto-invokes firecrawl/firecrawl-claude-plugin skills at the right gate).
---

# Activate the firecrawl overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay firecrawl <overlay-plugin-root>`
