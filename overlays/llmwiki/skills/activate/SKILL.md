---
name: activate
description: Activate the Flowy llmwiki overlay for this session (auto-invokes Pratiyush/llm-wiki skills at the right gate).
---

# Activate the llmwiki overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay llmwiki <overlay-plugin-root>`
