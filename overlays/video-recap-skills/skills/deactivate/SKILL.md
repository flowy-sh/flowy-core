---
name: deactivate
description: Deactivate the Flowy video-recap-skills overlay for this session (clears its routing obligation).
---

# Deactivate the video-recap-skills overlay

Invoke `flowy-core:_activator` with the argument:  `deactivate video-recap-skills`

This forwards to the engine's DEACTIVATE path, which removes the `video-recap-skills` entry from
