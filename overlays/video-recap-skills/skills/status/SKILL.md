---
name: status
description: Report whether the Flowy video-recap-skills overlay is active and whether the enforcement hook is live this session.
---

# Status of the video-recap-skills overlay
