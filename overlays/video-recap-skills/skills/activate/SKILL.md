---
name: activate
description: Activate the Flowy video-recap-skills overlay for this session (auto-invokes worldwonderer/video-recap-skills skills at the right gate).
---

# Activate the video-recap-skills overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay video-recap-skills <overlay-plugin-root>`
