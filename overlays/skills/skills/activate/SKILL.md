---
name: activate
description: Activate the Flowy skills overlay for this session (auto-invokes AI-Builder-Club/skills skills at the right gate).
---

# Activate the skills overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay skills <overlay-plugin-root>`
