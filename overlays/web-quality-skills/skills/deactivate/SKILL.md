---
name: deactivate
description: Deactivate the Flowy web-quality-skills overlay for this session (clears its routing obligation).
---

# Deactivate the web-quality-skills overlay

Invoke `flowy-core:_activator` with the argument:  `deactivate web-quality-skills`

This forwards to the engine's DEACTIVATE path, which removes the `web-quality-skills` entry from
