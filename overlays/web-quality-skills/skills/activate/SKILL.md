---
name: activate
description: Activate the Flowy web-quality-skills overlay for this session (auto-invokes addyosmani/web-quality-skills skills at the right gate).
---

# Activate the web-quality-skills overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay web-quality-skills <overlay-plugin-root>`
