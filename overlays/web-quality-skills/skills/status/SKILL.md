---
name: status
description: Report whether the Flowy web-quality-skills overlay is active and whether the enforcement hook is live this session.
---

# Status of the web-quality-skills overlay
