---
name: activate
description: Activate the Flowy woterclip overlay for this session (auto-invokes wotai-dev/woterclip skills at the right gate).
---

# Activate the woterclip overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay woterclip <overlay-plugin-root>`
