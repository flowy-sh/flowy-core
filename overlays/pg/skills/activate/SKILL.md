---
name: activate
description: Activate the Flowy pg overlay for this session (auto-invokes timescale/pg-aiguide skills at the right gate).
---

# Activate the pg overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay pg <overlay-plugin-root>`
