---
name: status
description: Report whether the Flowy codex-bridge overlay is active and whether the enforcement hook is live this session.
---

# Status of the codex-bridge overlay
