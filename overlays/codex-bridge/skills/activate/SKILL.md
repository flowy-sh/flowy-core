---
name: activate
description: Activate the Flowy codex-bridge overlay for this session (auto-invokes Sateezg/codex-bridge skills at the right gate).
---

# Activate the codex-bridge overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay codex-bridge <overlay-plugin-root>`
