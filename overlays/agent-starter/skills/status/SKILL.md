---
name: status
description: Report whether the Flowy agent-starter overlay is active and whether the enforcement hook is live this session.
---

# Status of the agent-starter overlay
