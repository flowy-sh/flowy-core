---
name: activate
description: Activate the Flowy agent-starter overlay for this session (auto-invokes sneg55/agent-starter skills at the right gate).
---

# Activate the agent-starter overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay agent-starter <overlay-plugin-root>`
