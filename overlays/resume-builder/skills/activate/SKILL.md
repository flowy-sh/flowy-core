---
name: activate
description: Activate the Flowy resume-builder overlay for this session (auto-invokes jananthan30/Resume-Builder skills at the right gate).
---

# Activate the resume-builder overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay resume-builder <overlay-plugin-root>`
