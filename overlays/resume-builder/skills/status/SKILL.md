---
name: status
description: Report whether the Flowy resume-builder overlay is active and whether the enforcement hook is live this session.
---

# Status of the resume-builder overlay
