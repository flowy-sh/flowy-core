---
name: status
description: Report whether the Flowy ai-software-architect overlay is active and whether the enforcement hook is live this session.
---

# Status of the ai-software-architect overlay
