---
name: deactivate
description: Deactivate the Flowy ai-software-architect overlay for this session (clears its routing obligation).
---

# Deactivate the ai-software-architect overlay

Invoke `flowy-core:_activator` with the argument:  `deactivate ai-software-architect`

This forwards to the engine's DEACTIVATE path, which removes the `ai-software-architect` entry from
