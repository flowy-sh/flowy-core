---
name: activate
description: Activate the Flowy superpowers overlay for this session (auto-invokes obra/superpowers skills at the right gate).
---

# Activate the superpowers overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay superpowers <overlay-plugin-root>`
