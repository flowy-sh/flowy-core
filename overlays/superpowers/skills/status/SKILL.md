---
name: status
description: Report whether the Flowy superpowers overlay is active and whether the enforcement hook is live this session.
---

# Status of the superpowers overlay
