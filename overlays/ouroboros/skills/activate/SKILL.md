---
name: activate
description: Activate the Flowy ouroboros overlay for this session (auto-invokes Q00/ouroboros skills at the right gate).
---

# Activate the ouroboros overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay ouroboros <overlay-plugin-root>`
