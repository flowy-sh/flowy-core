---
name: activate
description: Activate the Flowy readwise overlay for this session (auto-invokes readwiseio/readwise-skills skills at the right gate).
---

# Activate the readwise overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay readwise <overlay-plugin-root>`
