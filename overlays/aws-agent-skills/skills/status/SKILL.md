---
name: status
description: Report whether the Flowy aws-agent-skills overlay is active and whether the enforcement hook is live this session.
---

# Status of the aws-agent-skills overlay
