---
name: activate
description: Activate the Flowy aws-agent-skills overlay for this session (auto-invokes itsmostafa/aws-agent-skills skills at the right gate).
---

# Activate the aws-agent-skills overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay aws-agent-skills <overlay-plugin-root>`
