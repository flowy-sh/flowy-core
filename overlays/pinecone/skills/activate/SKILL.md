---
name: activate
description: Activate the Flowy pinecone overlay for this session (auto-invokes pinecone-io/pinecone-claude-code-plugin skills at the right gate).
---

# Activate the pinecone overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay pinecone <overlay-plugin-root>`
