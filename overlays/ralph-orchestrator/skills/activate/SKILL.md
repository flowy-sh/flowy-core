---
name: activate
description: Activate the Flowy ralph-orchestrator overlay for this session (auto-invokes mikeyobrien/ralph-orchestrator skills at the right gate).
---

# Activate the ralph-orchestrator overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay ralph-orchestrator <overlay-plugin-root>`
