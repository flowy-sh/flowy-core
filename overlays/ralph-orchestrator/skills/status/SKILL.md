---
name: status
description: Report whether the Flowy ralph-orchestrator overlay is active and whether the enforcement hook is live this session.
---

# Status of the ralph-orchestrator overlay
