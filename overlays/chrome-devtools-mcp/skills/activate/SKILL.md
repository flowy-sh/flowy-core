---
name: activate
description: Activate the Flowy chrome-devtools-mcp overlay for this session (auto-invokes ChromeDevTools/chrome-devtools-mcp skills at the right gate).
---

# Activate the chrome-devtools-mcp overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay chrome-devtools-mcp <overlay-plugin-root>`
