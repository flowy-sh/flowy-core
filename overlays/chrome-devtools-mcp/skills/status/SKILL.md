---
name: status
description: Report whether the Flowy chrome-devtools-mcp overlay is active and whether the enforcement hook is live this session.
---

# Status of the chrome-devtools-mcp overlay
