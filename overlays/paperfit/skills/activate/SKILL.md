---
name: activate
description: Activate the Flowy paperfit overlay for this session (auto-invokes OpenRaiser/PaperFit skills at the right gate).
---

# Activate the paperfit overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay paperfit <overlay-plugin-root>`
