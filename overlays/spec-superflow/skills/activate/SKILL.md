---
name: activate
description: Activate the Flowy spec-superflow overlay for this session (auto-invokes MageByte-Zero/spec-superflow skills at the right gate).
---

# Activate the spec-superflow overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay spec-superflow <overlay-plugin-root>`
