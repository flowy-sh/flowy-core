---
name: status
description: Report whether the Flowy spec-superflow overlay is active and whether the enforcement hook is live this session.
---

# Status of the spec-superflow overlay
