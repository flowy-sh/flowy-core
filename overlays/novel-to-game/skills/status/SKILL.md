---
name: status
description: Report whether the Flowy novel-to-game overlay is active and whether the enforcement hook is live this session.
---

# Status of the novel-to-game overlay
