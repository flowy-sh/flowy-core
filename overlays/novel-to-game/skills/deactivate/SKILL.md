---
name: deactivate
description: Deactivate the Flowy novel-to-game overlay for this session (clears its routing obligation).
---

# Deactivate the novel-to-game overlay

Invoke `flowy-core:_activator` with the argument:  `deactivate novel-to-game`

This forwards to the engine's DEACTIVATE path, which removes the `novel-to-game` entry from
