---
name: activate
description: Activate the Flowy repowire overlay for this session (auto-invokes prassanna-ravishankar/repowire skills at the right gate).
---

# Activate the repowire overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay repowire <overlay-plugin-root>`
