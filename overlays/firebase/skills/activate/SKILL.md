---
name: activate
description: Activate the Flowy firebase overlay for this session (auto-invokes firebase/skills skills at the right gate).
---

# Activate the firebase overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay firebase <overlay-plugin-root>`
