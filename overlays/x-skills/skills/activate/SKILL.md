---
name: activate
description: Activate the Flowy x-skills overlay for this session (auto-invokes sergebulaev/x-skills skills at the right gate).
---

# Activate the x-skills overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay x-skills <overlay-plugin-root>`
