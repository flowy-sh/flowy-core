---
name: status
description: Report whether the Flowy open-design overlay is active and whether the enforcement hook is live this session.
---

# Status of the open-design overlay
