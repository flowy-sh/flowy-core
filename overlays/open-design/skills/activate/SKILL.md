---
name: activate
description: Activate the Flowy open-design overlay for this session (auto-invokes nexu-io/open-design skills at the right gate).
---

# Activate the open-design overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay open-design <overlay-plugin-root>`
