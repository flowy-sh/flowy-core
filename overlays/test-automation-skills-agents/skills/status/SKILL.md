---
name: status
description: Report whether the Flowy test-automation-skills-agents overlay is active and whether the enforcement hook is live this session.
---

# Status of the test-automation-skills-agents overlay
