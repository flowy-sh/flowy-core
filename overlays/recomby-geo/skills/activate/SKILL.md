---
name: activate
description: Activate the Flowy recomby-geo overlay for this session (auto-invokes recomby-ai/recomby-geo skills at the right gate).
---

# Activate the recomby-geo overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay recomby-geo <overlay-plugin-root>`
