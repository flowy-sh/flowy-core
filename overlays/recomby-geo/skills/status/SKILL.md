---
name: status
description: Report whether the Flowy recomby-geo overlay is active and whether the enforcement hook is live this session.
---

# Status of the recomby-geo overlay
