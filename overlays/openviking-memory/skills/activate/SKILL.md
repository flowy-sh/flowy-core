---
name: activate
description: Activate the Flowy openviking-memory overlay for this session (auto-invokes volcengine/openviking skills at the right gate).
---

# Activate the openviking-memory overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay openviking-memory <overlay-plugin-root>`
