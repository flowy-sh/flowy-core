---
name: status
description: Report whether the Flowy openviking-memory overlay is active and whether the enforcement hook is live this session.
---

# Status of the openviking-memory overlay
