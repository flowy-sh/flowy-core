---
name: status
description: Report whether the Flowy n8n-mcp-skills overlay is active and whether the enforcement hook is live this session.
---

# Status of the n8n-mcp-skills overlay
