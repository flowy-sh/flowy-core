---
name: activate
description: Activate the Flowy n8n-mcp-skills overlay for this session (auto-invokes czlonkowski/n8n-skills skills at the right gate).
---

# Activate the n8n-mcp-skills overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay n8n-mcp-skills <overlay-plugin-root>`
