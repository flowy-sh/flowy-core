---
name: deactivate
description: Deactivate the Flowy n8n-mcp-skills overlay for this session (clears its routing obligation).
---

# Deactivate the n8n-mcp-skills overlay

Invoke `flowy-core:_activator` with the argument:  `deactivate n8n-mcp-skills`

This forwards to the engine's DEACTIVATE path, which removes the `n8n-mcp-skills` entry from
