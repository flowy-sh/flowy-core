---
name: activate
description: Activate the Flowy xberg overlay for this session (auto-invokes kreuzberg-dev/kreuzberg skills at the right gate).
---

# Activate the xberg overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay xberg <overlay-plugin-root>`
