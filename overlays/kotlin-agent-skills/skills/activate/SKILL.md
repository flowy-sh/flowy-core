---
name: activate
description: Activate the Flowy kotlin-agent-skills overlay for this session (auto-invokes kotlin/kotlin-agent-skills skills at the right gate).
---

# Activate the kotlin-agent-skills overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay kotlin-agent-skills <overlay-plugin-root>`
