---
name: status
description: Report whether the Flowy kotlin-agent-skills overlay is active and whether the enforcement hook is live this session.
---

# Status of the kotlin-agent-skills overlay
