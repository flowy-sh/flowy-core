---
name: status
description: Report whether the Flowy tencentdb-agent-memory overlay is active and whether the enforcement hook is live this session.
---

# Status of the tencentdb-agent-memory overlay
