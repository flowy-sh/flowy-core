---
name: activate
description: Activate the Flowy tencentdb-agent-memory overlay for this session (auto-invokes baodq97/tencentdb-agent-memory skills at the right gate).
---

# Activate the tencentdb-agent-memory overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay tencentdb-agent-memory <overlay-plugin-root>`
