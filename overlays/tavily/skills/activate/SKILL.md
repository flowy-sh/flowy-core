---
name: activate
description: Activate the Flowy tavily overlay for this session (auto-invokes tavily-ai/skills skills at the right gate).
---

# Activate the tavily overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay tavily <overlay-plugin-root>`
