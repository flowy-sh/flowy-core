---
name: activate
description: Activate the Flowy pup overlay for this session (auto-invokes DataDog/pup skills at the right gate).
---

# Activate the pup overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay pup <overlay-plugin-root>`
