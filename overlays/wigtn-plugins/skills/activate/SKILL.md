---
name: activate
description: Activate the Flowy wigtn-plugins overlay for this session (auto-invokes wigtn/wigtn-plugins skills at the right gate).
---

# Activate the wigtn-plugins overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay wigtn-plugins <overlay-plugin-root>`
