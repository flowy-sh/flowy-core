---
name: status
description: Report whether the Flowy wigtn-plugins overlay is active and whether the enforcement hook is live this session.
---

# Status of the wigtn-plugins overlay
