---
name: status
description: Report whether the Flowy claudelint overlay is active and whether the enforcement hook is live this session.
---

# Status of the claudelint overlay
