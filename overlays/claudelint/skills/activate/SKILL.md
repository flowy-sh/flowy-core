---
name: activate
description: Activate the Flowy claudelint overlay for this session (auto-invokes pdugan20/claudelint skills at the right gate).
---

# Activate the claudelint overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay claudelint <overlay-plugin-root>`
