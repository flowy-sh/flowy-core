---
name: status
description: Report whether the Flowy agentmemory overlay is active and whether the enforcement hook is live this session.
---

# Status of the agentmemory overlay
