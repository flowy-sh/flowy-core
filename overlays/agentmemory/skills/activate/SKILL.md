---
name: activate
description: Activate the Flowy agentmemory overlay for this session (auto-invokes rohitg00/agentmemory skills at the right gate).
---

# Activate the agentmemory overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay agentmemory <overlay-plugin-root>`
