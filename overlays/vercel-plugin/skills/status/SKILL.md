---
name: status
description: Report whether the Flowy vercel-plugin overlay is active and whether the enforcement hook is live this session.
---

# Status of the vercel-plugin overlay
