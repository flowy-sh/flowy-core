---
name: status
description: Report whether the Flowy langchain-skills overlay is active and whether the enforcement hook is live this session.
---

# Status of the langchain-skills overlay
