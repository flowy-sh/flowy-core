---
name: activate
description: Activate the Flowy langchain-skills overlay for this session (auto-invokes langchain-ai/langchain-skills skills at the right gate).
---

# Activate the langchain-skills overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay langchain-skills <overlay-plugin-root>`
