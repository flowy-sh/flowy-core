---
name: status
description: Report whether the Flowy taste-skill overlay is active and whether the enforcement hook is live this session.
---

# Status of the taste-skill overlay
