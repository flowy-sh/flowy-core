---
name: activate
description: Activate the Flowy taste-skill overlay for this session (auto-invokes leonxlnx/taste-skill skills at the right gate).
---

# Activate the taste-skill overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay taste-skill <overlay-plugin-root>`
