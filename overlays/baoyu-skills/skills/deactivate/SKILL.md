---
name: deactivate
description: Deactivate the Flowy baoyu-skills overlay for this session (clears its routing obligation).
---

# Deactivate the baoyu-skills overlay

Invoke `flowy-core:_activator` with the argument:  `deactivate baoyu-skills`

This forwards to the engine's DEACTIVATE path, which removes the `baoyu-skills` entry from
