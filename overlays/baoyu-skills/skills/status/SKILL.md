---
name: status
description: Report whether the Flowy baoyu-skills overlay is active and whether the enforcement hook is live this session.
---

# Status of the baoyu-skills overlay
