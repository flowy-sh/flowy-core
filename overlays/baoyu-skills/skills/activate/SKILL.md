---
name: activate
description: Activate the Flowy baoyu-skills overlay for this session (auto-invokes jimliu/baoyu-skills skills at the right gate).
---

# Activate the baoyu-skills overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay baoyu-skills <overlay-plugin-root>`
