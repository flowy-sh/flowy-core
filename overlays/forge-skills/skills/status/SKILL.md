---
name: status
description: Report whether the Flowy forge-skills overlay is active and whether the enforcement hook is live this session.
---

# Status of the forge-skills overlay
