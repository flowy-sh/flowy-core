---
name: activate
description: Activate the Flowy forge-skills overlay for this session (auto-invokes atlassian/forge-skills skills at the right gate).
---

# Activate the forge-skills overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay forge-skills <overlay-plugin-root>`
