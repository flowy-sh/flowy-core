---
name: deactivate
description: Deactivate the Flowy forge-skills overlay for this session (clears its routing obligation).
---

# Deactivate the forge-skills overlay

Invoke `flowy-core:_activator` with the argument:  `deactivate forge-skills`

This forwards to the engine's DEACTIVATE path, which removes the `forge-skills` entry from
