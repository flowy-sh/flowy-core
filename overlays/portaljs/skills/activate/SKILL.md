---
name: activate
description: Activate the Flowy portaljs overlay for this session (auto-invokes datopian/portaljs skills at the right gate).
---

# Activate the portaljs overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay portaljs <overlay-plugin-root>`
