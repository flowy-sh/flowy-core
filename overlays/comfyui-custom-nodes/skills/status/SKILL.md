---
name: status
description: Report whether the Flowy comfyui-custom-nodes overlay is active and whether the enforcement hook is live this session.
---

# Status of the comfyui-custom-nodes overlay
