---
name: activate
description: Activate the Flowy comfyui-custom-nodes overlay for this session (auto-invokes jtydhr88/comfyui-custom-node-skills skills at the right gate).
---

# Activate the comfyui-custom-nodes overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay comfyui-custom-nodes <overlay-plugin-root>`
