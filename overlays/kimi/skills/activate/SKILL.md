---
name: activate
description: Activate the Flowy kimi overlay for this session (auto-invokes linxule/kimi-plugin-cc skills at the right gate).
---

# Activate the kimi overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay kimi <overlay-plugin-root>`
