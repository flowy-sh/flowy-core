---
name: status
description: Report whether the Flowy alfred-dev overlay is active and whether the enforcement hook is live this session.
---

# Status of the alfred-dev overlay
