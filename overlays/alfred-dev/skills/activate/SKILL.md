---
name: activate
description: Activate the Flowy alfred-dev overlay for this session (auto-invokes 686f6c61/alfred-dev skills at the right gate).
---

# Activate the alfred-dev overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay alfred-dev <overlay-plugin-root>`
