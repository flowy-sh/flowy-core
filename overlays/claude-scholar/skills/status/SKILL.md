---
name: status
description: Report whether the Flowy claude-scholar overlay is active and whether the enforcement hook is live this session.
---

# Status of the claude-scholar overlay
