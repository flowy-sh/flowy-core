---
name: activate
description: Activate the Flowy claude-scholar overlay for this session (auto-invokes galaxy-dawn/claude-scholar skills at the right gate).
---

# Activate the claude-scholar overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay claude-scholar <overlay-plugin-root>`
