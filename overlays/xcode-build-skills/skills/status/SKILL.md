---
name: status
description: Report whether the Flowy xcode-build-skills overlay is active and whether the enforcement hook is live this session.
---

# Status of the xcode-build-skills overlay
