---
name: activate
description: Activate the Flowy stark overlay for this session (auto-invokes f0d010c/stark skills at the right gate).
---

# Activate the stark overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay stark <overlay-plugin-root>`
