---
name: activate
description: Activate the Flowy aso-skills overlay for this session (auto-invokes eronred/aso-skills skills at the right gate).
---

# Activate the aso-skills overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay aso-skills <overlay-plugin-root>`
