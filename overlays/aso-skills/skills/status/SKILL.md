---
name: status
description: Report whether the Flowy aso-skills overlay is active and whether the enforcement hook is live this session.
---

# Status of the aso-skills overlay
