---
name: activate
description: Activate the Flowy kicad-happy overlay for this session (auto-invokes aklofas/kicad-happy skills at the right gate).
---

# Activate the kicad-happy overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay kicad-happy <overlay-plugin-root>`
