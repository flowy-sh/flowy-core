---
name: status
description: Report whether the Flowy kicad-happy overlay is active and whether the enforcement hook is live this session.
---

# Status of the kicad-happy overlay
