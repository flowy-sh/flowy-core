---
name: deactivate
description: Deactivate the Flowy understand-anything overlay for this session (clears its routing obligation).
---

# Deactivate the understand-anything overlay

Invoke `flowy-core:_activator` with the argument:  `deactivate understand-anything`

This forwards to the engine's DEACTIVATE path, which removes the `understand-anything` entry from
