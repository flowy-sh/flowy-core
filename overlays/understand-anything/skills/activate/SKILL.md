---
name: activate
description: Activate the Flowy understand-anything overlay for this session (auto-invokes lum1104/understand-anything skills at the right gate).
---

# Activate the understand-anything overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay understand-anything <overlay-plugin-root>`
