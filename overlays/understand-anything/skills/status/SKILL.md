---
name: status
description: Report whether the Flowy understand-anything overlay is active and whether the enforcement hook is live this session.
---

# Status of the understand-anything overlay
