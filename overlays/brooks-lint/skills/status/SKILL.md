---
name: status
description: Report whether the Flowy brooks-lint overlay is active and whether the enforcement hook is live this session.
---

# Status of the brooks-lint overlay
