---
name: status
description: Report whether the Flowy claude-blog overlay is active and whether the enforcement hook is live this session.
---

# Status of the claude-blog overlay
