---
name: activate
description: Activate the Flowy claude-blog overlay for this session (auto-invokes agricidaniel/claude-blog skills at the right gate).
---

# Activate the claude-blog overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay claude-blog <overlay-plugin-root>`
