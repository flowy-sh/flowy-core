---
name: activate
description: Activate the Flowy superloopy overlay for this session (auto-invokes beefiker/superloopy skills at the right gate).
---

# Activate the superloopy overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay superloopy <overlay-plugin-root>`
