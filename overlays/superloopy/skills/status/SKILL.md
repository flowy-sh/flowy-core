---
name: status
description: Report whether the Flowy superloopy overlay is active and whether the enforcement hook is live this session.
---

# Status of the superloopy overlay
