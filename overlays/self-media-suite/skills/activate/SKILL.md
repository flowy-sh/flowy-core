---
name: activate
description: Activate the Flowy self-media-suite overlay for this session (auto-invokes yanhua1010/self-media-content-workflow skills at the right gate).
---

# Activate the self-media-suite overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay self-media-suite <overlay-plugin-root>`
