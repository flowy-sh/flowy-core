---
name: status
description: Report whether the Flowy self-media-suite overlay is active and whether the enforcement hook is live this session.
---

# Status of the self-media-suite overlay
