---
name: activate
description: Activate the Flowy ponytail overlay for this session (auto-invokes DietrichGebert/ponytail skills at the right gate).
---

# Activate the ponytail overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay ponytail <overlay-plugin-root>`
