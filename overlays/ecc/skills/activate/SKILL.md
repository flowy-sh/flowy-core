---
name: activate
description: Activate the Flowy ecc overlay for this session (auto-invokes affaan-m/ECC skills at the right gate).
---

# Activate the ecc overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay ecc <overlay-plugin-root>`
