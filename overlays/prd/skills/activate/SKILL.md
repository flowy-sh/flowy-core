---
name: activate
description: Activate the Flowy prd overlay for this session (auto-invokes anombyte93/prd-taskmaster skills at the right gate).
---

# Activate the prd overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay prd <overlay-plugin-root>`
