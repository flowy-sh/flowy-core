---
name: activate
description: Activate the Flowy pai-pro overlay for this session (auto-invokes Utopai-Research/pai-pro skills at the right gate).
---

# Activate the pai-pro overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay pai-pro <overlay-plugin-root>`
