---
name: activate
description: Activate the Flowy agent-skills overlay for this session (auto-invokes addyosmani/agent-skills at the right gate).
---

# Activate the agent-skills overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay agent-skills <overlay-plugin-root>`
