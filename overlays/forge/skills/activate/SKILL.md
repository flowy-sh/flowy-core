---
name: activate
description: Activate the Flowy forge overlay for this session (auto-invokes LucasDuys/forge skills at the right gate).
---

# Activate the forge overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay forge <overlay-plugin-root>`
