---
name: activate
description: Activate the Flowy humanize overlay for this session (auto-invokes PolyArch/humanize skills at the right gate).
---

# Activate the humanize overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay humanize <overlay-plugin-root>`
