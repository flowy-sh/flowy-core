---
name: activate
description: Activate the Flowy cortex overlay for this session (auto-invokes XBlueSky/cortexes skills at the right gate).
---

# Activate the cortex overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay cortex <overlay-plugin-root>`
