---
name: activate
description: Activate the Flowy dx overlay for this session (auto-invokes ykdojo/claude-code-tips skills at the right gate).
---

# Activate the dx overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay dx <overlay-plugin-root>`
