---
name: activate
description: Activate the Flowy ck overlay for this session (auto-invokes JuliusBrussee/cavekit skills at the right gate).
---

# Activate the ck overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay ck <overlay-plugin-root>`
