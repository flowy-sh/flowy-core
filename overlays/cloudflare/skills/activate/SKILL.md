---
name: activate
description: Activate the Flowy cloudflare overlay for this session (auto-invokes cloudflare/cloudflare-skills skills at the right gate).
---

# Activate the cloudflare overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay cloudflare <overlay-plugin-root>`
