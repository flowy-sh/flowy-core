---
name: status
description: Report whether the Flowy cloudflare overlay is active and whether the enforcement hook is live this session.
---

# Status of the cloudflare overlay
