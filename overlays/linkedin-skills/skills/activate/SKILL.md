---
name: activate
description: Activate the Flowy linkedin-skills overlay for this session (auto-invokes sergebulaev/linkedin-skills skills at the right gate).
---

# Activate the linkedin-skills overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay linkedin-skills <overlay-plugin-root>`
