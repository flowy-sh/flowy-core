---
name: status
description: Report whether the Flowy linkedin-skills overlay is active and whether the enforcement hook is live this session.
---

# Status of the linkedin-skills overlay
