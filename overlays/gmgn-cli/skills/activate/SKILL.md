---
name: activate
description: Activate the Flowy gmgn-cli overlay for this session (auto-invokes gmgnai/gmgn-skills skills at the right gate).
---

# Activate the gmgn-cli overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay gmgn-cli <overlay-plugin-root>`
