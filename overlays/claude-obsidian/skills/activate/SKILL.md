---
name: activate
description: Activate the Flowy claude-obsidian overlay for this session (auto-invokes agricidaniel/claude-obsidian skills at the right gate).
---

# Activate the claude-obsidian overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay claude-obsidian <overlay-plugin-root>`
