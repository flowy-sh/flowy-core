---
name: status
description: Report whether the Flowy claude-obsidian overlay is active and whether the enforcement hook is live this session.
---

# Status of the claude-obsidian overlay
