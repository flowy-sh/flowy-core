---
name: activate
description: Activate the Flowy openzeppelin-skills overlay for this session (auto-invokes OpenZeppelin/openzeppelin-skills skills at the right gate).
---

# Activate the openzeppelin-skills overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay openzeppelin-skills <overlay-plugin-root>`
