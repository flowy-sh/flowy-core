---
name: status
description: Report whether the Flowy openzeppelin-skills overlay is active and whether the enforcement hook is live this session.
---

# Status of the openzeppelin-skills overlay
