---
name: status
description: Report whether the Flowy dotnet-artisan overlay is active and whether the enforcement hook is live this session.
---

# Status of the dotnet-artisan overlay
