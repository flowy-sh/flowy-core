---
name: activate
description: Activate the Flowy dotnet-artisan overlay for this session (auto-invokes novotnyllc/dotnet-artisan skills at the right gate).
---

# Activate the dotnet-artisan overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay dotnet-artisan <overlay-plugin-root>`
