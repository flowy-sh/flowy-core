---
name: status
description: Report whether the Flowy academic-skills overlay is active and whether the enforcement hook is live this session.
---

# Status of the academic-skills overlay
