---
name: activate
description: Activate the Flowy academic-skills overlay for this session (auto-invokes ShZhao27208/Aut_Sci_Write skills at the right gate).
---

# Activate the academic-skills overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay academic-skills <overlay-plugin-root>`
