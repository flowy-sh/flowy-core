---
name: activate
description: Activate the Flowy hi-vibe overlay for this session (auto-invokes jx-hxxx/hi-vibe skills at the right gate).
---

# Activate the hi-vibe overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay hi-vibe <overlay-plugin-root>`
