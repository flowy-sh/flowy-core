---
name: deactivate
description: Deactivate the Flowy hi-vibe overlay for this session (clears its routing obligation).
---

# Deactivate the hi-vibe overlay

Invoke `flowy-core:_activator` with the argument:  `deactivate hi-vibe`

This forwards to the engine's DEACTIVATE path, which removes the `hi-vibe` entry from
