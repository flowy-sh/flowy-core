---
name: activate
description: Activate the Flowy azure overlay for this session (auto-invokes microsoft/azure-skills skills at the right gate).
---

# Activate the azure overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay azure <overlay-plugin-root>`
