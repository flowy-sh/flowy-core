---
name: status
description: Report whether the Flowy evals-skills overlay is active and whether the enforcement hook is live this session.
---

# Status of the evals-skills overlay
