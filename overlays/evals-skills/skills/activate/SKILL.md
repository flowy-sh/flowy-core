---
name: activate
description: Activate the Flowy evals-skills overlay for this session (auto-invokes hamelsmu/evals-skills skills at the right gate).
---

# Activate the evals-skills overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay evals-skills <overlay-plugin-root>`
