---
name: status
description: Report whether the Flowy edgeone-makers-tools overlay is active and whether the enforcement hook is live this session.
---

# Status of the edgeone-makers-tools overlay
