---
name: status
description: Report whether the Flowy claude-ads overlay is active and whether the enforcement hook is live this session.
---

# Status of the claude-ads overlay
