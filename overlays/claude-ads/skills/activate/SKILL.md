---
name: activate
description: Activate the Flowy claude-ads overlay for this session (auto-invokes agricidaniel/claude-ads skills at the right gate).
---

# Activate the claude-ads overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay claude-ads <overlay-plugin-root>`
