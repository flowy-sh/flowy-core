---
name: status
description: Report whether the Flowy coder-eval overlay is active and whether the enforcement hook is live this session.
---

# Status of the coder-eval overlay
