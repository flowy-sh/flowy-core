---
name: activate
description: Activate the Flowy coder-eval overlay for this session (auto-invokes UiPath/coder_eval skills at the right gate).
---

# Activate the coder-eval overlay
...
Invoke `flowy-core:_activator` with the argument:  `overlay coder-eval <overlay-plugin-root>`
